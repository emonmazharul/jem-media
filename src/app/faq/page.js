...
const faqs = [
    {
      ...
      content: "In today’s digital age, your customers are online. Digital marketing allows you to reach them effectively and affordably. It offers precise targeting, real-time performance tracking, and higher ROI compared to traditional methods. Enhance your online presence, stay ahead of competitors, and engage your audience with personalised content. Our expertise ensures your brand remains relevant and visible, driving growth and success. Partner with us to unlock your full digital potential!",
      active: false,
    },
    {
      title: "How do I request a consultation?",
      content:"Please submit a query using the contact form at the bottom of the page and a specialist from our team will respond to you as soon as possible. Alternatively, if you wish to schedule a call, click the unlock button and a specialist can talk you through the best options for your business, at a time best suited to you!",
      active: false,
    },
    {
