                ...
                <div className="md:w-1/3 md:flex md:justify-center">
                    <ul className="list-none flex justify-center gap-x-6 md:block md:mx-auto space-y-4">
                        <li className="mt-4 md:mt-0">
                            <a href="https://www.facebook.com/profile.php?id=61564244532399" target="blank">
                        ...
                        <li>
                            <a href="https://www.instagram.com/jemdigitaluk?igsh=MXA0b3dkaGMwdWtzeA%3D%3D&utm_source=qr" target="blank">
                                <Image
