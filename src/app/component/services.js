export function Services(){
    return <>
        <section id="services" className="service_section mb-20 md:mb-10  md:py-20">
            ...
            <div className="container md:mx-auto md:w-[1200px]">
                <div className="text-center flex flex-wrap justify-center md:gap-8 gap-y-8 md:gap-y-16">
                    {/* service one */}
                    <div className="service_card md:px-4 md:py-4 md:w-[35%] transition-all duration-300 hover:scale-105 ease-in-out">
                    ...
                    {/* service two */}
                    <div className="service_card md:px-4 md:py-4 md:w-[35%] transition-all duration-300 hover:scale-105 delay-75 ease-in-out">
                    ...
                    <div className="service_card md:px-4 md:py-4 md:w-[30%] transition-all duration-300  delay-75 hover:scale-105 ease-in-out">
                    ...
                    <div className="service_card md:px-4 md:py-4 md:w-[30%] transition-all duration-300 hover:scale-105 delay-75 ease-in-out">
